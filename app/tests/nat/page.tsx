...
export default function NATPage() {
  const testSections = [
    {
      ...
      skills: ['Grammar & vocabulary', 'Reading comprehension', 'Sentence correction', 'Synonyms & antonyms'],
    },
    {
      title: 'Quantitative Ability',
      description: 'Mathematical and numerical reasoning',
      skills: ['Basic arithmetic', 'Algebra fundamentals', 'Logical reasoning', 'Data interpretation'],
    },
    {
      title: 'Analytical Reasoning',
      description: 'Problem-solving and critical thinking',
      skills: ['Pattern recognition', 'Logical sequences', 'Critical analysis', 'Problem-solving strategies'],
    },
  ];

  const courseFeatures = [
    'Experienced NAT instructors',
  ...
  const batchSchedule = [
    { type: 'Regular Batch', duration: '4 weeks', classes: '2 hours/day, 5 days/week', timing: 'Morning (7-9 AM) & Evening (5-7 PM)' },
    { type: 'Weekend Batch', duration: '6 weeks', classes: '3 hours/day, Saturday & Sunday', timing: '10 AM - 1 PM' },
    { type: 'Crash Course', duration: '2 weeks', classes: '3 hours/day, 6 days/week', timing: 'Flexible timing' },
  ];
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white pt-20">
        <section className="relative text-white py-20 bg-cover bg-center" style={{backgroundImage: "url('https://images.unsplash.com/photo-1606326608606-aa0b62935f2b?w=1600&q=80')"}}>
          <div className="absolute inset-0 bg-gradient-to-r from-orange-900/90 to-orange-700/90"></div>
          <div className="container mx-auto px-4 lg:px-8 relative z-10">
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl">
              ...
              <h1 className="text-5xl md:text-6xl font-bold mb-6">NAT Preparation</h1>
              <p className="text-xl text-white/90 mb-4">
                National Aptitude Test
              </p>
              <p className="text-lg text-white/80 mb-8">
                A comprehensive aptitude test assessing your verbal, quantitative, and analytical abilities. Essential for various academic and professional opportunities.
              </p>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                  <div className="text-3xl font-bold mb-1">Pass/Fail</div>
                  <div className="text-white/80 text-sm">Assessment</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                  ...
                  <div className="text-white/80 text-sm">Attempts</div>
                </div>
              </div>
            </motion.div>
          </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-5xl mx-auto">
              {courseFeatures.map((feature, index) => (
                <motion.div
                  ...
                  className="flex items-center space-x-3 bg-gradient-to-r from-orange-50 to-yellow-50 p-4 rounded-lg"
                >
        ...
        <section className="py-16 bg-gradient-to-br from-orange-600 to-orange-800 text-white">
          <div className="container mx-auto px-4 lg:px-8 text-center">
            <h2 className="text-4xl font-bold mb-6">Ready to Start Your NAT Preparation?</h2>
            <p className="text-xl text-white/90 mb-10 max-w-3xl mx-auto">
              Excel in your National Aptitude Test with our comprehensive preparation program. Expert guidance and proven strategies!
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="bg-white text-orange-700 px-8 py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transition-all flex items-center space-x-2"
              >
                <Award className="w-6 h-6" />
                <span>Enroll Now</span>
              </motion.button>
              <motion.a
                href="https://wa.me/9779851352807?text=Hi, I'm interested in NAT preparation course"
                target="_blank"
