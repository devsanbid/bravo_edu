...
export default function JobsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-12 md:py-20 mt-20">
      ...
      {/* Branch Selector */}
      <section className="py-4 md:py-8 bg-white shadow-sm">
            ...
            <div className="grid gap-6">
              {jobs.map((job) => (
                <motion.div
                  ...
                  className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all p-4 md:p-6"
                >
                  <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                    <div className="flex-1">
                      {/* Mobile: Icon above text, Desktop: Icon beside text */}
                      <div className="flex flex-col sm:flex-row items-start gap-3 md:gap-4">
                        <div className="bg-blue-100 p-3 rounded-lg flex-shrink-0 mx-auto sm:mx-0">
                          <Briefcase className="w-6 h-6 text-blue-600" />
                        </div>
                        <div className="flex-1 min-w-0 w-full">
                          <h3 className="text-lg md:text-xl lg:text-2xl font-bold text-gray-900 mb-2 text-center sm:text-left">{job.title}</h3>
                          
                          <div className="flex flex-wrap justify-center sm:justify-start gap-2 md:gap-4 text-xs md:text-sm text-gray-600 mb-3 md:mb-4">
                            ...
                            <span className="flex items-center gap-1">
                              ...
                              <span className="hidden sm:inline">Deadline: </span>{new Date(job.deadline).toLocaleDateString('en-US', { month: 'short', day: 'numeric' })}
                            </span>
                          </div>
                          ...
                          {expandedJobId === job.$id ? (
                            <>
                              <div className="mb-3 md:mb-4">
                                ...
                                <p className="text-gray-700 leading-relaxed whitespace-pre-line text-sm md:text-base">{job.description}</p>
                              </div>
                              ...
                              <div className="bg-gray-50 rounded-lg p-3 md:p-4 mb-3 md:mb-4">
                                ...
                                <p className="text-gray-700 text-xs md:text-sm whitespace-pre-line">{job.requirements}</p>
                              </div>

                              <button
                                onClick={() => setExpandedJobId(null)}
                                className="text-blue-600 hover:text-blue-700 font-medium text-xs md:text-sm mb-3 md:mb-4"
                              >
                                Show Less
                              </button>
                            </>
                            ...
                            <>
                              <p className="text-gray-700 mb-3 md:mb-4 leading-relaxed line-clamp-2 text-sm md:text-base">{job.description}</p>
                              <button
                    ...
                    <button
                      ...
                      className="w-full md:w-auto bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-6 md:px-8 py-2.5 md:py-3 rounded-lg font-semibold transition-all shadow-md hover:shadow-lg text-sm md:text-base"
                    >
                      Apply Now
                    </button>
                  </div>
