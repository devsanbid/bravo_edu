...
export default function UKPage() {
  ...
  const requirements = [
    {
      ...
      icon: GraduationCap,
      items: [
        'Undergraduate: High school diploma with good grades',
        'Postgraduate: Bachelor\'s degree in relevant field',
        'Minimum GPA requirements vary by university',
      ],
    },
    {
      ...
      icon: FileText,
      items: [
        'IELTS: Overall 6.0-7.5 (varies by course)',
        'TOEFL: 80-100 (iBT)',
        'PTE Academic: 59-75',
  ...
  const visaProcess = [
    'Receive university offer letter',
    'Pay tuition deposit and get CAS',
    'Prepare financial documents',
    'Apply for Student Visa (Tier 4)',
    'Attend visa interview if required',
    'Receive visa decision (2-3 weeks)',
  ];
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white pt-20">
        {/* Hero Section */}
        <section className="relative text-white py-20 bg-cover bg-center" style={{backgroundImage: "url('https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?w=1600&q=80')"}}>
          ...
          <div className="container mx-auto px-4 lg:px-8 relative z-10">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl font-bold mb-6">Study in the United Kingdom</h1>
              <p className="text-xl text-white/90 mb-8">
                Experience world-class education in one of the most prestigious education systems globally. 
                The UK offers a rich academic tradition, cutting-edge research, and a multicultural environment.
              </p>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                  ...
                  <div className="text-white/80 text-sm">Global Ranking</div>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <section className="py-16 bg-gradient-to-br from-primary-purple to-primary-purple-light text-white">
          <div className="container mx-auto px-4 lg:px-8">
            <h2 className="text-4xl font-bold mb-12 text-center">Why Study in the UK?</h2>
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
              {popularCourses.map((course, index) => (
                <motion.div
                  ...
                  className="bg-gradient-to-r from-blue-50 to-purple-50 p-4 rounded-lg text-center font-semibold text-text-dark hover:shadow-md transition-shadow"
                >
                  {course}
                </motion.div>
              ))}
          ...
          <div className="container mx-auto px-4 lg:px-8">
            ...
            <div className="max-w-3xl mx-auto">
              {visaProcess.map((step, index) => (
                ...
                >
                  <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center text-white font-bold">
                    {index + 1}
                  </div>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 lg:px-8 text-center">
            <h2 className="text-3xl font-bold mb-6">Ready to Start Your UK Journey?</h2>
